import { getCustomer, getCasesForOrganization } from './customer-store.js';
...
export function assessSupportRequest(request) {
  ...
  return {
    ...
    issue: related
      ...
      : { classification: 'new_issue', confidence: 0.8, recommendedAction: 'create_new_case' },
    nextStep: channelEligible
      ? (related ? 'Confirm the details and add this report to the existing case.' : 'Create a new support case using the eligible service level.')
